...
> This document contains the concrete code patterns and examples for building features on top of the iZimate v2 architecture. The system design describes *what* and *why*; this document shows *how*.
